...
namespace PolygonAreaCalculator
{
    public partial class MainForm : Form
    {
        ...
        /// 1.рисуем многоугольник на рабочей поверхности или вводим координаты вручную
        /// 2. преобразовываем многоугольник в выпуклый с целью исключения пересечений сторон и
        /// непоследовательного ввода координат точек
        /// 3. разбиваем многоугольник на непересекающиеся треугольники
        /// 4. вычисляем площадь каждого треугольника
        /// 5. суммируем площадь треугольников и выводим результат
        /// </summary>
        public MainForm()
        {
            InitializeComponent();
